...
(function(){
  ...
  function liveBoot(){
    ...
    try {
      ...
      if(pl) pl.innerHTML = 'If you tap <b>Locate Me</b>, a position rounded to about 1&nbsp;km is sent to our server to fetch your local forecast and is not kept; your exact position stays on your device. No third-party analytics and no crash reports. This version sends GoHawaii daily visit totals. They cover the island, the beaches and places opened, tabs used, taps out, advisory pop-ups, the hour, your language and your kind of device. No id, no location, and nothing at all if your browser sends Do Not Track. Photos and map tiles load straight from the sites that host them, gohawaii.com included, so those sites see your IP address and that you came from this site. Full list: ' + lnk + '.';
      if(dp) dp.innerHTML = 'No accounts and no signup: we never learn your name. No third-party analytics and no crash reports in this build. It sends GoHawaii daily visit totals with no id and no location, and none under Do Not Track. If you tap Locate&nbsp;Me, a position rounded to about 1&nbsp;km goes to our server to fetch your local forecast and is not kept. Full detail: ' + lnk + '.';
    } catch(e){}
