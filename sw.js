...
const CACHE_VERSION = 'v191-2026-07-22-desktop-map-contrast';
...
if (workbox) {
  ...
  workbox.routing.registerRoute(
    ({ url }) => url.origin === self.location.origin && /^\/(jade[a-z-]*|sales|hotel-signup|timeshare-signup|stay-close-operator-dashboard|analytics-console)\.html$/.test(url.pathname),
    new workbox.strategies.NetworkFirst({
