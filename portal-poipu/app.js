...
// Poipu Surf Shop is hand-onboarded through Close already on the Paid plan —
// this instance defaults real mode to "paid" rather than gating a shop that
// was never Free. When Paid is wired to read the partner row directly, swap
// this default for that read; until then this is a per-operator default, not
// a general self-serve upgrade path.
window.OCEANSAFE_PLAN = (function () {
  const fallback = DEMO ? "paid" : "paid";
